...
printf '\nSetup complete.\n'
printf '\nWhat happened:\n'
printf '- Local config written to setup.local.env.\n'
printf '- Project starter files were created only when missing.\n'
printf '- Existing project and Vault files were kept.\n'
printf '- Public readiness check passed before optional GitHub steps.\n'
printf '\nNext steps:\n'
