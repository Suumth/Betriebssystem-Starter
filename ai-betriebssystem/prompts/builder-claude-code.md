...
```text
Arbeite im Repo OWNER/REPO an Issue #ISSUE. Du bist Escalation Builder nach dokumentierter menschlicher Freigabe. Nutze ausschließlich GitHub als Kontextquelle: Issue, PR, Kommentare, AGENTS.md und Repo-Dateien. Lies nicht den AI Vault.

Einstieg:
1. Lies das Issue vollständig: Agent Contract, Goal, Boundary, Verification, Evidence, Closeout, Stop-Bedingung.
