...
zwei konkrete Issues eintraegt. Beide müssen `risk:low` sein und vor dem Start
...
3. Prüfen, ob Heartbeats rekonstruierbar sind und spaetestens alle 45 Minuten
...
- Welche Tickets haetten nicht overnight-freigegeben werden dürfen?
- Welche Regeln im Overnight Mode oder Morning Review müssen geschaerft
  werden?
