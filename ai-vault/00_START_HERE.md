...
Der AI Vault ist nicht das operative System. Er ist das Projektgedaechtnis.
...
2. Nur stabile Erkenntnisse in den Vault uebernehmen.
...
5. Lessons nach abgeschlossenen Loops kurz und wiederverwendbar schreiben.
...
5. Nach jedem relevanten PR pruefst du, ob Entscheidungen, Risiken oder Lessons zurueckfliessen muessen.

## Rollen

- GitHub: Arbeit, Lieferung, Review, Evidence.
- `PROJECT.md`: Router zwischen Repo, Vault und Methode.
- `AGENTS.md`: operative Agentenregeln.
- Vault: Gedaechtnis und Strategie.
- Mensch: Gate fuer Schutzbereiche, Richtung und Freigabe.
